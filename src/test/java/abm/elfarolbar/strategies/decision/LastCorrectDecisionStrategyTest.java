...
public class LastCorrectDecisionStrategyTest {
    ...
    public void decide_returnsTrue_whenLastDecisionIsNotCrowded() {
        ...
        assertThat("Returns true, if last bar attendance was not crowded", strategy.decide(bar), is(true));
    }
    ...
    public void decide_returnsTrue_whenLastDecisionIsCrowded() {
        ...
        assertThat("Returns false, if last bar attendance was crowded", strategy.decide(bar), is(false));
    }
